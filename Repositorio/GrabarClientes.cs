...
namespace Repositorio
{
    public class GrabarClientes : IGrabarClientes
    {
        ...
        public async Task<bool> InsertClientes(TABLE_CLIENTES_TURNOS ClientesTurnos)
        {
            try
            {
        ...
        public async Task<bool> GrabarCita(TABLE_ASESOR_HORARIO Models_Clientes_Citasx)
        {
