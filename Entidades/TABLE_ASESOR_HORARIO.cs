...
namespace Entidades
{
    public class TABLE_ASESOR_HORARIO
    {
        public string? STRCEDULA { get; set; }

        public string? STRCODIGOLUGARATENCION { get; set; }
        public string? STRCODIGOASESORASIGNADO { get; set; }
        public string? STRFECHARESERVA { get; set; }
        public string? STRHORARESERVA { get; set; }
        public string? STRFECHAREALATENCION { get; set; }
        public string? STRHORAREALATENCION { get; set; }
        public string? STRESTADOATENCION { get; set; }
