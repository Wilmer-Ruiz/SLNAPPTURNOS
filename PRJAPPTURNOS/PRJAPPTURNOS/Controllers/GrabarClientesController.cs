...
namespace PRJAPPTURNOS.Controllers
{
    ...
    public class GrabarClientesController : Controller
    {
        ...
        public GrabarClientesController(IGrabarClientes GrabarClientesparam)
        {
        ...
        /// <returns></returns>      
        [HttpPost("PostGrabar")]
        public async Task<IActionResult> Post([FromBody] TABLE_CLIENTES_TURNOS ClientesTurnos)
        {
        ...
        /// <returns></returns>      
        [HttpPost("GrabarCita")]
        public async Task<IActionResult> GrabarCita([FromBody] TABLE_ASESOR_HORARIO Models_Clientes_Citasx)
        {
